...
from CreateRune import create as createRune
...
def TPAction(data):
    ...
    if data['actionId'] == "KillerBOSS.Plugin.LoLPlugin.actions.PutUserinQueue":
        ...
        http.post("/lol-lobby/v2/lobby", json={"queueId" : Queues[data['data'][0]['value']]})
    ...
    if data['actionId'] == "LoLPlugin.actions.QueueResponses":
        http.post(f"/lol-matchmaking/v1/ready-check/{data['data'][0]['value']}")
